...
const svg = d3.select("div#my-d3-chart")
    .append("svg")
...
d3.csv("https://gist.githubusercontent.com/jgoodie/1472bb58c250fd1b29ccb6206d5d1904/raw/40681dee8f2889aebcc1b0bbe10ce2fe15a954c0/iris.csv").then( function(data) {
    // clean/fix the data
    ...
    d3.select("div#my-d3-chart").on("click", update);
})